...
//					(txtID.getText()+"#"+txtName.getText()+"#"+txtAge.getText()+"#"+txtNation.getText()+"#"+civilStat.getSelectedItem()+"#"+ genderFinal +"#"+txtNum.getText()+"#"+txtEmail.getText()+"#"+txtDept.getText()+"#"+txtPos.getText()+"#"+"\n");
					...
					txtAge.setText(model.getValueAt(roww,2).toString());
					txtNation.setText(model.getValueAt(roww,3).toString());				
			...
			try {
				...
				fw.write(txtID.getText()+"#"+txtName.getText()+"#"+txtAge.getText()+"#"+txtNation.getText()+"#"+civilStat.getSelectedItem()+"#"+ genderFinal +"#"+txtNum.getText()+"#"+txtEmail.getText()+"#"+txtDept.getText()+"#"+txtPos.getText()+"#"+"\n");
				fw.close();
		...
		btnUpdate.addActionListener(e ->{
			...
			try {
				...
				if(row1==selectedRow) {
					...
					String newRec = txtID.getText()+"#"+txtName.getText()+"#"+txtAge.getText()+"#"+txtNation.getText()+"#"+civilStat.getSelectedItem()+"#"+ group.getSelection().getActionCommand() +"#"+txtNum.getText()+"#"+txtEmail.getText()+"#"+txtDept.getText()+"#"+txtPos.getText()+"#";
					lines.add(newRec);
				}else {
					lines.add(line);
				}
			...
			try {
				...
				for(String rec:lines) bw.write(rec+"\n");
